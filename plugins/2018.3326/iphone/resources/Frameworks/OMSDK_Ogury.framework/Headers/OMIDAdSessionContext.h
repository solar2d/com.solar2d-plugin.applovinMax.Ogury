 ...
 */
@interface OMIDOguryAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDOguryPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDOguryPartner *)partner
                               ...
                               resources:(NSArray<OMIDOguryVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
...
- (nullable instancetype)initWithPartner:(OMIDOguryPartner *)partner
                              ...
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                           universalAdID:(nullable OMIDOguryUniversalAdID *)universalAdID
                                   error:(NSError *_Nullable *_Nullable)error;
